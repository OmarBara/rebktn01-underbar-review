(function() {
  ...
  describe('Part I', function() {
    ...
    describe('indexOf', function() {
      ...
      xit('returns the first index that the target can be found at when there are multiple matches', function() {
    ...
    describe('uniq', function() {
      ...
      it('should maintain same array length', function() {
        ...
        expect(numbers.length).to.equal(numbers.length);
      });
    });
    ...
    describe('reduce', function() {
      ...
      xit('should pass items of the array into the iterator from left to right', function() {
        var orderTraversed = [];

        _.reduce(orderTraversed, function(memo, item) {
          // FILL_ME_IN
